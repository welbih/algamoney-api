...
//	private String originPermitida = "http://localhost:8000"; // TODO: Configurar para diferentes ambiente. Já adicionado na configuração externa
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if("OPTIONS".equals(req.getMethod()) && algamoneyApiProperty.getOriginPermitida().equals(req.getHeader("Origin"))) {
			...
			resp.setHeader("Access-Control-Allow-Methods", "Authorazation, Content-Type, Accept");
